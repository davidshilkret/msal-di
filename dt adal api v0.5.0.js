...
var DocIntADAL = (function () {
    ...
    DocIntADAL = function () {
        return DocIntADAL.prototype._instance;
    };

    DocIntADAL = function (clientId, tenant, spUri, noPopup) {
        var configPopup = {
            'tenant': tenant,
            'clientId': clientId,
            'endpoints': {
        ...
        if (DocIntADAL.prototype._instance) {
            return DocIntADAL.prototype._instance;
        }
        ...
        DocIntADAL.prototype._instance = this;

        return DocIntADAL.prototype._instance;
    };

    DocIntADAL.prototype.context = new function () {
        return DocIntADAL.prototype._instance;
    };

    DocIntADAL.prototype.log = function (msg) {};

    DocIntADAL.prototype.loginUser = function () {
        var user = this.authContext.getCachedUser();

        return user;
    };

    DocIntADAL.prototype.login = function () {
    ...
    DocIntADAL.prototype.logout = function () {

        this.authContext._saveItem(LOGOUT_REDIRECT, window.top.location.href);
        this.authContext.logOut();
    };

    DocIntADAL.prototype.validateUser = function () {
        var user = this.authContext.getCachedUser();
    ...
    DocIntADAL.prototype.getToken = function (callback, graph) {
...
function doSiteValidationProcess(caller, isSubmit) {
    ...
    if (connectionType != SP_ONLINE_TYPE) {
        ...
        var _dtadlal = new DocIntADAL(client_id, tenant_name, conn_base_url, login_no_popup);
...
function getContentType(g_form, expr, arg) {
    ...
    function doGetConnection(caller) {
        ...
        if (connectionType != SP_ONLINE_TYPE) {
            ...
            //var _dtadlal = new DocIntADAL(client_id, tenant_name, conn_base_url);
