...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype.login = function () {
        ...
        if (!loginStartPage || loginStartPage === "") {
            ...
            //FW, address iframe x-frame-option deny issue
            loginStartPage = window.top.location.href;
        }
        else {
  ...
  */
    ...
    AuthenticationContext.prototype.logOut = function () {
        ...
        //FW, extend from original ADAL logout implementation
        if (this.config.displayLogout) {
            // User defined way of handling the navigation
            this.config.displayLogout(urlNavigate);
        }
        else {
            this.promptUser(urlNavigate);
        }
    ...
    */
    ...
    AuthenticationContext.prototype._serialize = function (responseType, obj, resource) {
        ...
        if (obj !== null) {
            ...
            //experimental scope=https://graph.microsoft.com/mail.read api://
            //str.push('scope=' + encodeURIComponent('openid profile Mail.ReadBasic'));
            //str.push('scope=' + encodeURIComponent('https://graph.microsoft.com/mail.read api://'));
            
            //MSAL
            //works with v2.0
            //str.push('scope=' + encodeURIComponent('openid mail.read mail.readbasic'));
